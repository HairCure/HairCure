    ...
    var body: some View {
        NavigationStack {
            VStack(spacing: 0) {
                ...
                // Give the ZStack all remaining vertical space so inner
                // ScrollViews (DietMate + MindEase) can actually scroll
            ...
            // ── iOS 17 large title that collapses & centres on scroll ──
