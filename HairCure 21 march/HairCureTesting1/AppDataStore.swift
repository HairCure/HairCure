...
class AppDataStore {
    ...
    private func seedSleepAndWater(userId: UUID) {
        ...
        // ── Water Intake Logs — 14 days, multiple cups per day ──
        ...
        let waterDays: [(Int, [CupSeed])] = [
            (0, [CupSeed(size:"medium",ml:250,hour:8,min:0),
                 CupSeed(size:"large", ml:400,hour:10,min:30),
                 CupSeed(size:"medium",ml:250,hour:13,min:0),
                 CupSeed(size:"small", ml:150,hour:16,min:0)]),
