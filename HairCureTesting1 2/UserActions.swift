...
//
//  Hair-Insights favourite actions (toggleFavorite, isFavorited, favouriteInsights, etc.)
//  have been moved to HairInsightsDataStore.  Use store.hairInsightsStore.setFavourited(...)
//  and store.hairInsightsStore.isFavourited(contentId:) from views instead.
//
//  Each method:
...
extension AppDataStore {
    ...
    // ─────────────────────────────────────────────
    // MARK: 10 — Calorie Bar Helper (DietMate UI)
    // ─────────────────────────────────────────────
